...
* Source https://github.com/rbur004/mac_wifi_scanner

## DESCRIPTION:

Wifi Scanner opens a text window for the output from 
 /System/Library/PrivateFrameworks/Apple80211.framework/Versions/Current/Resources/airport -s

Uses Platypus to take a shell script and turn it into an application. 
...
## INSTALL:
	...
	* Package version of the application is in the repository, with the modified nib.
	Otherwise
	* Open Wifi Scanner.platypus in application Platypus and click Create.
	* I also modified the NIB file to create a wider output window.
